...
### 1. batch 004 / 4181490939

- 状态：`verified`
- 装备：85级 SpeedSet Ring，`Epic`
- 复核节点：`+0 -> +3`
- 影子建议：`{"decision": "cautious_continue", "next_check_at": 3, "target": "half_tank_general"}`
- 资源闸门：`True`，消耗：`{"actual_material_delta": {"equipment_enhancement_powder": 2, "lesser_equipment_charm": 1}, "allowed_material_sources": ["equipment_enhancement_powder", "lesser_equipment_charm"], "authorized_limits": {"equipment_enhancement_powder": 2, "gold": 17600, "lesser_equipment_charm": 1}, "gold": {"after": 346677797, "authorized_limit": 17600, "before": 346695397, "consumed": 17600}, "selected_materials": {"equipment_enhancement_powder": 2, "lesser_equipment_charm": 1}, "within_limits": true}`
...
| 副属性 | [{"type": "DefensePercent", "value": 5}, {"type": "CriticalHitChancePercent", "value": 5}, {"type": "AttackPercent", "value": 6}, {"type": "Attack", "value": 38}] | [{"type": "DefensePercent", "value": 5}, {"type": "CriticalHitChancePercent", "value": 5}, {"type": "AttackPercent", "value": 13}, {"type": "Attack", "value": 38}] |
| 装备分数 | 27 | 37 |

- 变化字段：`[{"after": 19, "before": 12, "field": "main.value", "type": "HealthPercent"}, {"after": 13, "before": 6, "field": "substats[AttackPercent].value", "type": "AttackPercent"}, {"after": 37, "before": 27, "field": "gear_score"}]`
