...
def main(argv: list[str] | None = None) -> int:
    ...
    batch.add_argument("--gear-source", default="rift_new_1_32")
    ...
    simulate.add_argument("--gear-source", default="rift_new_1_32")
    ...
    calibrate.add_argument("--gear-source", default="rift_new_1_32")
